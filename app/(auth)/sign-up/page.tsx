        ...
        <section className='flex min-h-screen items-center justify-center px-6 py-12 sm:px-10'>
          <div className='w-full max-w-md'>
            ...
            <button
              ...
              className='h-12 my-4 w-full cursor-pointer rounded-lg border border-neutral-200 bg-white text-sm font-medium text-neutral-900 transition hover:bg-neutral-50'
            >
